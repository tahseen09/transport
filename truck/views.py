...
def new_trip(request):
    if request.method == "POST":
        ...
        context = {"msg":msg,"truck":truck, "sl_no":sl_no, "trip_start_date":trip_start_date, "source":source, "total_weight":total_weight, "cost":cost, "rec_weight":rec_weight, "tp_pass":tp_pass, "shortage":shortage, "less":less, "status":status, "diesel":diesel, "advance":advance, "mop":mop, "total_cost":total_cost}
